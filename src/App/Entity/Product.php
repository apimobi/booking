...
class Product
{
    ...
    *  @ORM\Column(type="string")
     ...
     *      joinColumns={ @ORM\JoinColumn(name="idProduct", referencedColumnName="idProduct")},
     *      inverseJoinColumns={ @ORM\JoinColumn(name="idProduct", referencedColumnName="idProduct", unique=true)}
     *      )
     */
    private $users;
